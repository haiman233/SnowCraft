...
public class IronGolemAssembler extends SlimefunItem {
    ...
    public IronGolemAssembler(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack[] recipe) {
            ...
            public void tick(final Block b, SlimefunItem sf, Config data) {
                ...
                if (lifetime % 60 == 0) {
                    ...
                    if (ironblock > 3 && pumpkin > 0) {
                        ...
                        Bukkit.getScheduler().scheduleSyncDelayedTask(SlimefunStartup.instance, () -> b.getWorld().spawnEntity(new Location(b.getWorld(), b.getX() + 0.5D, b.getY() + offset, b.getZ() + 0.5D), EntityType.IRON_GOLEM));
                    }
                }
            }
